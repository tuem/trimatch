...
public:
	...
	template<class back_insert_iterator>
	void approx(const text& query, integer max_edits, back_insert_iterator bi);
...
void index<text, integer, trie, approximate_matcher>::search_client::approx(
	const text& query, integer max_edits, back_insert_iterator bi)
{
...
void index<text, integer, trie, approximate_matcher>::search_client::approx_step(
	const text& query, approximate_matcher& matcher, integer root, text& current, back_insert_iterator& bi)
{
